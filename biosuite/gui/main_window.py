...
class BioSuiteApp(
    ...
    def _build_sidebar(self):
        ...
        ctk.CTkLabel(logo_area, text="v4.0.0", font=FONT_SMALL,
        ...
        ctk.CTkLabel(version_frame, text="v4.0.0", font=(FONT_FAMILY, 9),
    ...
    def _build_content(self):
        ...
        self._set_status("BioSuite Ultra v4.0.0 loaded successfully")
