...
- **Tested and scanned on every change.** 2,484 tests run on Python 3.10, 3.11 and 3.12, with
...
|---|---|
| Tests — Python 3.10 | 2484 passed, 14 skipped, 0 failed |
| Tests — Python 3.11 | 2484 passed, 14 skipped, 0 failed |
| Tests — Python 3.12 | 2484 passed, 14 skipped, 0 failed |
